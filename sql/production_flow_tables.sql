...
CREATE TABLE IF NOT EXISTS production_flow_events (
  ...
  KEY idx_production_flow_pattern_stage (pattern_id, stage),
  ...
  CONSTRAINT fk_production_flow_pattern FOREIGN KEY (pattern_id) REFERENCES api_lot_size_patterns(id) ON DELETE SET NULL,
