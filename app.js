...
const dihariRoutes = require('./routes/dihadiRoutes');
...
const videoFinderRoutes = require('./routes/videoFinderRoutes');
const urlScraperRoutes = require('./routes/urlScraperRoutes');
const mailManagerRoutes = require('./routes/mailManagerRoutes');
...
app.use('/video-finder', videoFinderRoutes);
app.use('/url-scraper', urlScraperRoutes);
app.use('/mail-manager', mailManagerRoutes);
